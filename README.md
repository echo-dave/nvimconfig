...
> [!IMPORTANT]
>
> - [Neovim](https://github.com/neovim/neovim/releases) v0.12+
> - [fd](https://github.com/sharkdp/fd?tab=readme-ov-file#installation) (fd-find on ubuntu) brew, apt
> - [fzf](https://github.com/junegunn/fzf/releases) brew, apt (outdated), binary
...
- [**telescope**](https://github.com/nvim-telescope/telescope.nvim) - searches for files, buffers, strings. todos from todo-comments, sessions from possession
